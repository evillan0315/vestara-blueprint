...
| **ADR-118** | **Multi-Agent Workflow Orchestration** | **accepted** | **2026-08-02** | [adr/ADR-118-multi-agent-workflow-orchestration.md](adr/ADR-118-multi-agent-workflow-orchestration.md) |
